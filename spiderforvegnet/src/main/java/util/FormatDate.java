...
//    static SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-M-dd");
//    static SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-M-dd");
//    static SimpleDateFormat sdf3 = new SimpleDateFormat("yyyy-M-d");
